...
export declare class MatSelectSearchComponent implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    */
    ...
    /** Subject that emits when the component has been destroyed. */
    private _onDestroy;
    constructor(matSelect: MatSelect, changeDetectorRef: ChangeDetectorRef, _viewportRuler: ViewportRuler, matOption: MatOption, liveAnnouncer: LiveAnnouncer, matFormField?: MatFormField, defaultOptions?: MatSelectSearchOptions);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<MatSelectSearchComponent, [null, null, null, { optional: true; }, null, { optional: true; }, { optional: true; }]>;
